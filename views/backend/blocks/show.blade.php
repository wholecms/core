...
@section('title'){{ trans('whole::blocks.show_title',['title'=>($settings->get()->admin_title!="") ? $settings->get()->admin_title : 'Whole CMS']) }}@endsection

@section('page_title')
    <h1>{{ trans('whole::blocks.show_page_title') }}</h1>
@endsection
...
@section('page_breadcrumb')
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="{{ route('admin.index') }}">{{ trans('whole::blocks.show_breadcrumb0') }}</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="{{ route('admin.block.index') }}">{{ trans('whole::blocks.show_breadcrumb1') }}</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="#">{{ trans('whole::blocks.show_breadcrumb2') }}</a>
        </li>
    </ul>
@endsection
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase">{{ trans('whole::blocks.show_portlet_title') }}</span>
                    </div>
                </div>
                ...
                <div class="portlet-body form">
					...
					<div class="text-right">
                        <button type="submit" class="post_attribute btn blue">{{ trans('whole::blocks.save') }}</button>
            ...
            <div class="row">
                <div class="scroll">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-comments"></i> {{ trans('whole::blocks.pages') }}
                            </div>
                            <div class="tools">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-comments"></i> {{ trans('whole::blocks.blocks') }}
                            </div>
                            <div class="tools">
                                <a href="javascript:;" class="collapse">
                                </a>
                                        ...
                                        @foreach($blocks as $item)
                                            <li class="dd-item dd-item" data-type="block" data-data_id="{{ $item->id }}">
                                                ...
                                                <div class="dd3-content"><a target="_blanks" href="{!! route('admin.block.edit',$item->id) !!}">{{ $item->name  }}</a>
                                                    [<a target="_blanks" href="{!! route('admin.block.show',$item->id) !!}">{{ trans('whole::blocks.fet') }}</a>]
                                                </div>
                                                <div class="dd-remove disabled"><a href="#"> <i class="fa fa-remove"></i> </a></div>
                                            </li>
                                        @endforeach
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-comments"></i> {{ trans('whole::blocks.contents') }}
                            </div>
                            <div class="tools">
                                <a href="javascript:;" class="collapse">
                                </a>
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-comments"></i> {{ trans('whole::blocks.components') }}
                            </div>
                            <div class="tools">
                                <a href="javascript:;" class="collapse">
                                </a>
...
//            var block_detail = JSON.parse('[{"type":"page","data_id":17,"children":[{"type":"page","data_id":16}]},{"type":"page","data_id":15}]');
            ...
            if (block_detail.length>0){$("#nl_block_attribute").html('<ol class="dd-list"></ol>');
                $("#nl_block_attribute").before('<div class="_load">{{ trans('whole::blocks.loading') }}</div>');
        ...
        $("form").on("submit",function(){
            ...
            $.ajax({
                ...
                success:function(response)
                {
                    ...
                    btn.html("{{ trans('whole::blocks.save') }}");
                }
            });
