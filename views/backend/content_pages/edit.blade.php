...
@section('title'){{ trans('whole::tr.content_pages.edit_title') }}@endsection

@section('page_title')
    <h1>{{ trans('whole::tr.content_pages.edit_page_title') }}</h1>
@endsection
...
@section('page_breadcrumb')
    <ul class="page-breadcrumb breadcrumb">
        <li>
            <a href="{{ route('admin.index') }}">{{ trans('whole::tr.content_pages.edit_breadcrumb0') }}</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="#">{{ trans('whole::tr.content_pages.edit_breadcrumb1') }}</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="{{ route('admin.content_page.index') }}">{{ trans('whole::tr.content_pages.edit_breadcrumb2') }}</a>
            <i class="fa fa-circle"></i>
        </li>
        <li>
            <a href="#">{{ trans('whole::tr.content_pages.edit_breadcrumb3') }}</a>
        </li>
    </ul>
@endsection
            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption font-green-haze" style="width: 100%;">
                        ...
                        <span class="caption-subject bold uppercase">{{ trans('whole::tr.content_pages.edit_portlet_title') }}</span>
                                ...
                                <div class="form-actions">
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <a href="{{ route('admin.content_page.index') }}" class="btn default">{{ trans('whole::tr.content_pages.back') }}</a>
                                        </div>
                                    </div>
                                </div>
                            {!! Form::close() !!}
            ...
            $("form").on("submit",function(){
                ...
                $.ajax({
                    ...
                    success:function(response)
                    {
                        ...
                        $(".form-actions button[type='submit']").html("{{ trans('whole::tr.content_pages.save') }}");
                    }
                });
