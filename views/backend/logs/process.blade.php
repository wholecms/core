            ...
            <div class="portlet light">
                <div class="portlet-title">
                    <div class="caption font-green-haze">
                        ...
                        <span class="caption-subject bold uppercase"> İşlem Logları</span>
                    </div>
                </div>
                    ...
                    {!! Form::open(['method' => 'delete','route'=>['admin.logs.clear'],'class'=>'form-horizontal','role'=>'form']) !!}
                        <div class="form-body" style="margin: 0;padding: 0;">
                            <div class="form-group">
                                <div class="col-md-12">
                                    {!! Form::textarea(null,$logs,['placeholder'=>'İşlem Logları Boş','class'=>'form-control','rows'=>15,'disabled'=>'disabled']) !!}
