...
{
    protected $fillable = ['content_page_id','menu_title','menu_description','menu_icon','menu_image','meta_title','meta_keywords','meta_description','title_visibility','status','access','link_target','content_embed','default','content_type','content_title','content_id','component_id','external_link'];
